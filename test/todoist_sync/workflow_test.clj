...
(deftest test-review-preference
  (testing "Testing parsing urls and review filtering"
    ...
    (is (= (list {:input-text "IJ-MR-108346 Fix postformatting for injected PSI elements that were marked as changed"
                  :issue      "IJ-MR-108346"
                  :td-type    :review
                  :url        "https://jetbrains.team/p/IJ/review/108346/timeline"}
                )
           (wf/classify-with-review-preference (thd/extract-issues-from-html "IJ-MR-108346 Fix postformatting for injected PSI elements that were marked as changed"
                                                                             ))
           ))
